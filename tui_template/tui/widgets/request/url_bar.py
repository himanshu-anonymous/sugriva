...
from tui.highlighters import VariablesAndUrlHighlighter
from tui.themes import UrlStyles, VariableStyles
from tui.variables import (
    extract_variable_name,
    get_variable_at_cursor,
    get_variables,
)
from tui.widgets.input import PostingInput
from tui.widgets.request.method_selection import MethodSelector
from tui.widgets.response.response_trace import Event
from tui.widgets.variable_autocomplete import VariableAutoComplete
...
class UrlBar(Vertical):
    ...
    def compose(self) -> ComposeResult:
        ...
        if not self.app.settings.url_bar.show_value_preview:
    ...
    def _display_variable_at_cursor(self) -> None:
        ...
        if variable_value:
            if self.app.settings.url_bar.hide_secrets_in_value_preview:
                if any(
