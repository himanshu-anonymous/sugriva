...
from tui.widgets.response.response_trace import ResponseTrace
from tui.widgets.response.script_output import ScriptOutput
from tui.widgets.tabbed_content import PostingTabbedContent
from tui.widgets.text_area import TextAreaFooter, TextEditor
from tui.widgets.response.cookies_table import CookiesSection
from tui.widgets.response.response_body import ResponseTextArea
from tui.widgets.response.response_headers import ResponseHeadersTable
...
class ResponseArea(Vertical):
    ...
    def watch_response(self, response: httpx.Response | None) -> None:
        ...
        response_settings = self.app.settings.response
