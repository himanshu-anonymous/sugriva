...
def highlight_variables(text: Text, styles: VariableStyles, active_variables: dict[str, Any]) -> None:
...
class VariableHighlighter(Highlighter):
    ...
    def highlight(self, text: Text) -> None:
        if self.variable_styles is None:
            return
        active_variables = {}
        if hasattr(self, "app") and hasattr(self.app, "backend"):
            active_variables = self.app.backend.get_variables()
        highlight_variables(text, self.variable_styles, active_variables)
...
class VariablesAndUrlHighlighter(Highlighter):
    ...
    def highlight(self, text: Text) -> None:
        ...
        active_variables = {}
        if hasattr(self.input, "app") and hasattr(self.input.app, "backend"):
            active_variables = self.input.app.backend.get_variables()
        highlight_variables(text, self.variable_styles, active_variables)
